...
toolbox create befunge93-vault-cracker-dev toolbox enter
befunge93-vault-cracker-dev # Install dependencies manually
...
befunge93-vault-cracker/ ├── src/ # Source code (Perimeter 1-2) ├── lib/
