...
While TEA is native to Elm and commonly used with AffineScript, this project demonstrates that the pattern works beautifully in vanilla JavaScript with React's `useReducer` hook. The core principles remain:
